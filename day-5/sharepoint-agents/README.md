...
> Typ: povinný · Den: 5 · Odhad: krátký blok — **instruktor jen ukáže** (tvorba = license-only)
...
[`lab-sharepoint-agent.md`](lab-sharepoint-agent.md) — instruktor demo: single-source limit naživo. Scénář: [`../copilot-agents/scenario-hr-agent.md`](../../day-4/copilot-agents/scenario-hr-agent.md).
