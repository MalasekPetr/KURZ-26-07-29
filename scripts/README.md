...
| 3. Demo data pro Graph lab (dost webů/položek na reálné stránkování) + `sites.json` pro Lab 1 | `New-CourseSeedData.ps1` `[PLÁNOVANÉ]` | PnP/Graph | `day-1/formats-fundamentals`, `day-3/graph-fundamentals` |
